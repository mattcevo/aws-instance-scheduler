...
class InstanceScheduler:
    ...
    def __init__(self, service, scheduler_configuration):
        ...
        # print("self._valid_regions: {}", self._valid_regions)
    ...
    def _process_account(self, account):
        ...
        for region in self._regions:
            ...
            for instance in self._scheduled_instances_in_region(account, region):
                ...
                # self._logger.debug(DEBUG_CURRENT_INSTANCE_STATE, instance.current_state, instance.instancetype,instance_schedule.name)
                self._logger.debug('instance : {}', str(instance))
                self._logger.debug(DEBUG_CURRENT_INSTANCE_STATE, instance.current_state, instance.service, instance_schedule.name)
